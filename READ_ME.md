...
Load and process data: \* OD data by occupation at msoa level from [UK Data Service](https://www.ukdataservice.ac.uk) \* LondonSquared layout via [After the flood](https://aftertheflood.com/projects/future-cities-catapult/) \* Boundary data via [ONS Open Geography](http://geoportal.statistics.gov.uk/)
